...
Versión C++ linux:
Se recomienda que todos los elementos aquí explicados se encuentren juntos en la misma carpeta.
-----------------------------------------------
...
- Para garantizar la máxima compatibilidad y velocidad, compilars la librería directamente en el sistema:
